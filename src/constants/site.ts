export const SITE = {
  ...
  cvPage: '/cv/',
  heroIntro:
    "Étudiante en MBA Design UI/UX, je conçois des produits numériques centrés utilisateur et j'interviens sur tout le cycle : recherche utilisateur, architecture de l'information, maquettes et prototypes interactifs, Design System, puis intégration front-end en React. Ma formation en réseaux informatiques m'apporte une vraie aisance technique.",
} as const;
